...
apt-get install -y flameshot python3 python2.7 reaver libssl-dev libnl-3-dev libnl-genl-3-dev ibssl-dev gcc hostapd pkg-config golang apache2 selinux-basics hcxtools rsh-client subfinder amass nmap kolourpaint whois ccrypt cifs-utils pacu routersploit reaver net-tools hping3 tcpdump netcat-traditional mdk4 git freeradius wget maltego keepassxc-full otpclient duplicity torbrowser-launcher netcat-openbsd socat dmitry whatweb python3-venv wget2 cargo 
echo ""
